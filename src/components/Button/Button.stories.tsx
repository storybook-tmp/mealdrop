...
export const Primary: Story = {
  ...
  play: async ({ canvas }) => {
    ...
    // Button uses theme color.buttonPrimary which is #202020 in light theme
...
export const CssCheck: Story = {
  ...
  play: async ({ canvas }) => {
    ...
    // StyledButton sets background-color to color.buttonPrimary which is #202020 in light theme
